...
Company creating drones for Drone delivery service.
\begin{itemize}
    \item Embedded redundant software developpements C++.
    \item Manage fleet deployement, communication layer (WIFI, 4G/LTE) and redundant systems (Linux, Python, C++, Docker).
\end{itemize}}
...
\cventry{2019 -- 2020}{R\&D Engineer}{\href{https://www.esoftthings.com/en/}{esoftthings}}{Cesson-Sévigné}{France}{%
...
\begin{itemize}
    \item Creation and evaluation of Driver Monitoring System algorithm, simulation and tests on the Ambarella CV22 SBC.
\end{itemize}}
...
\cventry{2013 -- 2024}{Lecturer}{}{}{}{
\begin{itemize}
 \item Lectures on robotics and drones in France and abroad ;
 \item Engineering school courses ;
\end{itemize}}
...
\cvcomputer{Embedded systems}{Linux SBC : Jetson, Beaglebone, Rasberry Pi, Odroid, X86; Microcontrôleurs : Esp8266/32, STM32; Android}
...
\cvcomputer{Platforms}{UGV (Unmanned Ground Vehicle), UAV (Unmanned Aerial Vehicle), USV (Unmanned Surface Vehicle), IOT}
...
\cvcomputer{Tools}{Git, Mercurial, Cmake, Waf, GitHub, Gitlab, Docker, Github Actions, LibIIO, MQTT, REST}
\cvcomputer{Methods}{TDD, Kanban, CI(Continuous Integration), PyTest, Gtest}
\cvcomputer{Operating Systems}{GNU/Linux (Debian, Ubuntu), Chibios, BalenaOS, Windows}
...
\begin{itemize}
	\item Code improvement for UGV, UAV and USV;
...
\cvhobby{Do-it-yourself}{Home staging, homelab, domotics and miscellaneous home improvements}
