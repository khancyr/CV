...
\usepackage[firstyear=2007,lastyear=2019]{moderntimeline}
%\tlmaxdates{1999}{2012}
% \tlwidth{0.8ex}
...
\begin{itemize}
 \item Création de la seconde version de \href{https://www.youtube.com/watch?v=TsEw0Ob9nrs}{la solution de drone autonome avec station d'accueil} et mise en production;
 ...
 \item Obtention de la première autorisation de vol autonome sans pilote en France.
 \item Encadrement du passage de 4 à 10 personnes ;
\end{itemize}}
...
\cvcomputer{Systèmes embarqués}{Type Linux SBC : Rasberry Pi, Odroid; Microcontrôleurs : Esp8266, Arduino, AVR, STM32; Android}
...
\cvcomputer{Frameworks}{\href{https://www.ros.org/}{ROS}\contributor, \href{ardupilot.org}{ArduPilot}\developer, HTML, Bootstrap, Websocket, Matlab}
\cvcomputer{Outils}{Git, Mercurial, Cmake, Waf, GitHub, Gitlab, Clion, Docker, Travis}
...
\tlcventry{2013}{2018}{Thèse CIFRE-Défense : Mécanismes de partage optimisé d'informations et de synchronisation entre systèmes embarqués au sein d'un essaim de drones}{\href{http://www.lab-sticc.fr/en/index/}{Labsticc/Retdtech France}}{Rennes}{\href{https://drive.google.com/open?id=1kunx6TPXdK-vvV7pQeexgF_9M8Roi05N}{Lien du manuscrit}}{}
...
\begin{itemize}
	\item Amélioration du code pour UGV et UAV;
 	...
 	\item Amélioration du simulateur SITL (Software In The Loop) et des autotest pour l'intégration continue;
