...
%\begin{itemize}
%	\item R\'eecriture du code du Rover pour accepter diff\'erentes configuration ;
...
-\cvcomputer{Syst\`emes}{Automatique, communication, localisation, intelligence embarqué, interface Homme-Machine (IHM)}
