...
\cventry{2017 -- Aujourd'hui}{Ing\'enieur R\&D}{\href{http://skeyetech.fr/}{Skeyetech/Azur drones}}{M\'erignac}{}{%
PME sp\'ecialis\'ee dans les solutions drones et les services associ\'es.
\begin{itemize}
 \item Mise en place de l'architecture syst\`emes et des simulations des nouvelles solutions technologiques ;
 \item Cr\'eation du prototype de la solution Drone Gard : drone autonome avec station d'accueil et de contrôle ;
 \item Impl\'ementation de nouvelles technologies de localisation (UWB, atterrissage de pr\'ecision, etc.) et de s\'ecurit\'e (redondance, estimation d'\'etat de batterie, bus CAN, etc.) ;
 \item Cr\'eation d'un environnement de tests et d'int\'egration continue automatis\'e ;
 \item Structuration de l'\'equipe logiciel (recrutement, formation, mise en place d'outils et de standard, gestion de projet).
\end{itemize}}

\cventry{2013 -- 2017}{Ing\'enieur d'\'etude}{\href{http://www.retdtechfrance.fr/}{Retdtechfrance}}{Rennes}{}{%
...
\begin{itemize}
 ...
 \item Cr\'eation d'IHM avec des technologies Web pour la commande des robots et l'affichage de vid\'eo en temps r\'eel ;
 \item Gestion de projet (voir mon profil linkedin pour les d\'etails), r\'eponses \`a consultations, \`a appels d'offres publics, r\'edaction de documentation technique et gestion des risques ;
 \item Participation \`a des projets de recherches multi-partenaires: Essaim de drones {\href{https://recherche.telecom-bretagne.eu/daisie}{DAISIE}}, Bras robot gonflable {\href{http://www.warein-sas.com/c/innovation}{Bulle}}
\end{itemize}}

\section{Comp\'etences}

\subsection{Robotique}
\cvcomputer{Syst\`emes embarqu\'es}{Type Rasberry Pi : Rasberry Pi, Odroid, Esp8266, Arduino, AVR, STM32, Android}
...
\cvcomputer{Frameworks}{ROS\contributor, OpenCV, Ardupilot\developer, HTML, Bootstrap, Websocket, Matlab, UAVCAN}
...
\begin{itemize}
	\item Soumission d\'un projet technique en anglais ;
	...
	\item R\'ealisation de 90\% des objectifs initiaux pr\'evu.
\end{itemize}}
