...
\cventry{2019 -- Aujourd'hui}{Ingénieur R\&D}{\href{https://www.esoftthings.com/en/}{esoftthings}}{Cesson-Sévigné}{}{%
...
\begin{itemize}
    \item Création et évaluation d'un algorithme d'estimation de distance des détections effectuées sur un rétroviseur électronique.
    \item Formation à l'ISO26262 et processus de création de code critique.
\end{itemize}}
...
\cvcomputer{Langages}{C, C++, Python, Shell/Bash/Zsh, GNU Make, JavaScript}
...
\cvhobby{Bricolage}{Home staging et diverses améliorations à la maison}
